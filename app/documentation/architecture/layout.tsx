...
export const metadata: Metadata = {
  title: "Architecture",
  description: "VerifiedSignal data plane: Postgres, OpenSearch, workers, Bedrock, and SSE.",
};

export default function ArchitectureDocsLayout({ children }: { children: ReactNode }) {
  return (
